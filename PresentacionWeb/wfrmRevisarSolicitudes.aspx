                    ...
                    <asp:GridView CssClass="table table-borderedtable-striped table-hover m-1" Style="width: 100%;" ID="GridView1" runat="server" AutoGenerateColumns="False">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Gestionar solicitud">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkAceptar" runat="server" CommandArgument='<%# Eval("idSolicitud").ToString() %>' OnCommand="lnkAceptar_Command"><i class="far fa-check-square"></i></asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
